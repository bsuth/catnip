...
static void
focus_view(struct tinywl_view* view, struct wlr_surface* surface)
{
...
desktop_view_at(struct tinywl_server* server,
                double lx,
                double ly,
...
static void
process_cursor_move(struct tinywl_server* server, uint32_t time)
{
...
static void
process_cursor_resize(struct tinywl_server* server, uint32_t time)
{
  /*
...
static void
begin_interactive(struct tinywl_view* view,
